        ...
        >
          ...
          >
            ...
            <Animated.View entering={FadeInDown.duration(1000).delay(200)} style={styles.welcomeSection}>
              ...
              <ThemedText style={styles.welcomeSubtitle}>Join us for fresh, pure water delivery</ThemedText>
            </Animated.View>
          </LinearGradient>
          ...
          <Animated.View entering={FadeInDown.duration(1000).delay(400)} style={styles.formContainer}>
            <View style={styles.form}>
              ...
              <View style={styles.inputWrapper}>
                ...
                <View style={styles.inputContainer}>
                  <IconSymbol name="envelope.fill" size={20} color="#1e88e5" style={styles.inputIcon} />
                  <TextInput
              ...
              <View style={styles.inputWrapper}>
                ...
                <View style={styles.inputContainer}>
                  <IconSymbol name="phone.fill" size={20} color="#1e88e5" style={styles.inputIcon} />
                  <TextInput
